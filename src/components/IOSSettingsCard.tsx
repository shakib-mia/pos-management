...
const IOSSettingsCard = () => {
	const [form, setForm] = useState({
		appStoreUrl: "",
		bundleId: "com.demo.store",
		minVersion: "1.0.0",
		latestVersion: "1.2.0",
		updateMessage:
			"A new version is available on the App Store. Please update to continue.",
		forceUpdate: false,
	});
		...
		<div className="rounded-xl border border-slate-200 bg-white shadow-sm">
			<div className="border-b border-slate-200 px-6 py-4">
				...
				<p className="mt-1 text-sm text-slate-500">
					Configure your iOS application settings.
				</p>
			</div>
...
export default IOSSettingsCard;
